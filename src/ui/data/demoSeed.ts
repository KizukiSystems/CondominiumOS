...
export const cachedAgendaItems: AgendaItem[] = [
  {
    ...
    options: [
      ...
      { id: 'o2', title: 'Award to Rideau Roofing', detail: 'Standard membrane recoat, no structural review.', meta: '$42,000', isManagerSuggestion: false },
      { id: 'o3', title: 'Award to Capital Membrane', detail: 'Higher quote; raised the structural concern.', meta: '$51,000', isManagerSuggestion: false },
    ],
    talkingPoints:
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'o5', title: 'Request a compliance check', detail: 'Have management verify occupancy on-site.', meta: '', isManagerSuggestion: false },
      { id: 'o6', title: 'Refer to legal counsel', detail: 'Begin the enforcement process now.', meta: 'Higher cost', isManagerSuggestion: false },
    ],
    talkingPoints:
  ...
  },
  {
    ...
    needsEngineer: false,
    options: [
      { id: 'o7', title: 'Renew with Cardinal', detail: 'Continuity with the prior study; rate held at last cycle’s.', meta: '$6,800', isManagerSuggestion: true },
      { id: 'o8', title: 'Solicit competing quotes', detail: 'Compare the market before committing.', meta: 'Adds lead time', isManagerSuggestion: false },
    ],
    talkingPoints:
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'o10', title: 'Order an electrical capacity study', detail: 'Assess building load before approving installations.', meta: 'Cost to be quoted', isManagerSuggestion: false },
      { id: 'o11', title: 'Defer pending legal review', detail: 'Draft a formal policy before any approval.', meta: 'Slower', isManagerSuggestion: false },
    ],
    talkingPoints:
  ...
  },
  {
    ...
    needsEngineer: false,
    options: [
      { id: 'o12', title: 'Offer a payment plan, then lien', detail: 'Set a dated plan; register a lien if it is missed.', meta: 'Balanced', isManagerSuggestion: true },
      { id: 'o13', title: 'Register liens now', detail: "Protect the corporation's position immediately.", meta: 'Firm', isManagerSuggestion: false },
      { id: 'o14', title: 'Refer to collections', detail: 'Hand both files to counsel.', meta: 'Highest cost', isManagerSuggestion: false },
    ],
    talkingPoints:
